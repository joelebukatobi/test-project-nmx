document.addEventListener('DOMContentLoaded', function () {
  ...
  // Array of image links corresponding to each customer
  const customerAvatar = [
    'https://images.unsplash.com/photo-1597071058713-6776461d7737',
    'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d',
    'https://images.unsplash.com/photo-1557053908-4793c484d06f',
    'https://images.unsplash.com/photo-1607503873903-c5e95f80d7b9',
    'https://images.unsplash.com/photo-1554727242-741c14fa561c',
      ...
      .then((data) => {
        ...
        data.forEach((customer, index) => {
          ...
          article.innerHTML = `
            ...
            <section>  
            <div class="picture">
            <img src="${customerAvatar[index]}" alt="${customer.name}'s Picture">
            </div>
            <header>
                <h4>${customer.name}</h4>
